...
function watch_storage_1(network)
    ...
    function affect!(integrator)
		...
		# @info "Line killed at t=$(integrator.t)."
		# if (u[indices[1]] > 1.) | (u[indices[1]] < 0.)
		if (u[indices[1]] <= 1.) & (u[indices[1]] >= 0)
			integrator.f.f.edges![2].f!.K = 6.
			integrator.f.f.edges![4].f!.K = 6.
			integrator.f.f.edges![5].f!.K = 6.
		else
			integrator.f.f.edges![2].f!.K = 0
			integrator.f.f.edges![4].f!.K = 0
			integrator.f.f.edges![5].f!.K = 0
		end
