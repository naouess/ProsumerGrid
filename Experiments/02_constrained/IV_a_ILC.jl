...
begin
	...
	# savefig("$dir/plots/IV_real_ILC_omega.png")
end
...
begin
	...
	# savefig("$dir/plots/IV_real_ILC_BatteryStuff.pdf")
end
...
begin
	...
	savefig("$dir/plots/IV_real_ILC_sum_exact.pdf")
end
...
begin
	...
	# savefig("$dir/plots/IV_real_ILC_mismatch_secondwise_mismatch.pdf")
end
...
begin
	...
	ylims!(-1,1.)
	# savefig("$dir/plots/IV_real_ILC_node1.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (0:3600*24:num_days*24*3600, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
    ylims!(-1,1)
	# savefig("$dir/plots/IV_real_ILC_node2.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (1:3600*24:num_days*24*3600+1, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
	ylims!(-1,1)
	# savefig("$dir/plots/IV_real_ILC_node3.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (0:3600*24:num_days*24*3600, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
	ylims!(-1,1)
	# savefig("$dir/plots/IV_real_ILC_node4.pdf")
end

begin
	l = @layout [a b; c d]
	plot_demand = plot(p1,p2,p3,p4, layout = l, xaxis=("Days", font(10)))
	# savefig("$dir/plots/IV_real_ILC_layout4Nodes.pdf")
end
