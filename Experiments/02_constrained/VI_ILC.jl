...
begin
	...
	# savefig("$dir/plots/VI_allILC_omega.png")
end
...
plot(sol, vars = syms_containing(nd, "χ"), legend = true)
...
begin
	...
	# savefig("$dir/plots/VI_allILC_BatteryStuff.pdf")
end
...
begin
	...
	savefig("$dir/plots/VI_allILC_sum_exact.png")
end
...
begin
	...
	# savefig("$dir/plots/VI_allILC_mismatch_secondwise.pdf")
end
...
begin
	...
	ylims!(-1,1.)
	savefig("$dir/plots/VI_allILC_node1.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (0:3600*24:num_days*24*3600, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
    ylims!(-1,1)
	savefig("$dir/plots/VI_allILC_node2.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (1:3600*24:num_days*24*3600+1, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
	ylims!(-1,1)
	# savefig("$dir/plots/VI_allILC_node3.pdf")
end
...
begin
	...
	plot!(1:3600:num_days*24*3600, ILC_power_hourly_mean_node[1:num_days*24], xticks = (0:3600*24:num_days*24*3600, string.(0:num_days)), ytickfontsize=10,
	      xtickfontsize=10, legendfontsize=10, linewidth=3, yaxis=("Normed power",font(10)),legend=false, lc =:black, margin=5Plots.mm)
	ylims!(-1,1)
	# savefig("$dir/plots/VI_allILC_node4.pdf")
end
...
for (i,t) in enumerate(sol.t)
	...
	control_node[i] = ILC_power_node[i] + LI_power_node[i]
